...
const innovationCards = [
  ...
  { title: 'Environment', text: 'Monitoring and compliance with clear insights.' },
  ...
  return (
    <PageTransition>
      <section className='hero'>
        ...
        <div className='section-shell hero-content py-24 md:py-32'>
          ...
          <p className='mt-6 max-w-xl text-base md:text-lg text-white/80'>
            With decades of experience and a future-focused mindset, we support
            clients with accurate testing, custom research, and expert
            consultation. From life sciences to environmental monitoring, we
            deliver clarity through science.
          </p>
          ...
          <div className='mt-10 flex flex-wrap items-center gap-4 text-sm text-white/70'>
            <div className='flex -space-x-2'>
              <span className='h-8 w-8 rounded-full border border-white/40 bg-white/30' />
              <span className='h-8 w-8 rounded-full border border-white/40 bg-white/20' />
              <span className='h-8 w-8 rounded-full border border-white/40 bg-white/10' />
            </div>
            <span>16+ years of experience and 1,200+ client partnerships</span>
          </div>
        </div>
      </section>
