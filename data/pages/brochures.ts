...
export const brochures = deepFreeze([
  {
    ...
    summary:
      "Explore the live iClinRT brochure with a browser preview, product context, and a gated download flow for community members.",
    ...
    highlights: [
      ...
      "Community-signup gated download flow for lead capture",
    ],
  },
] as const);
